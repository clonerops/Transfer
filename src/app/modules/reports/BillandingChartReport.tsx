...
import {useBillandingChartRequest} from './core/_hooks'
...
const BillandingChartReport = () => {
  ...
  const {mutate, data: charts, isLoading} = useBillandingChartRequest()
  ...
  return (
    <Card5 title='گزارش آماری حواله ها' image='/media/svg/brand-logos/aven.svg'>
...
export default BillandingChartReport
